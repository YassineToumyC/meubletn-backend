...
return new class extends Migration
{
    ...
    {
        // Nullify FKs in announcements before deleting
        DB::table('announcements')->update(['category_id' => null, 'subcategory_id' => null]);

        DB::table('subcategories')->delete();
        DB::table('categories')->delete();

        foreach ($this->categories as $position => $data) {
